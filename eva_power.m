%evaluation function for phase two (power)
...
if(bool=='f')
    [vel_def]=eva_func_deficit_faster(interval_dir_num,N,coordinate,interval_dir,a,kappa,R);
else
...
%calculate the power output in the interval 
%divide the wind speed from cui-in speed(3.5m/s) to rated speed(14m/s)into
%35 intervals
